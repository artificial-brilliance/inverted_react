...
You MUST use the Observation/Thought/Action/Action Input pattern:
'''
...
'''
Observation: The observation from an action
...
Observation: To help the human MUST perform the following task: {task}
"""
